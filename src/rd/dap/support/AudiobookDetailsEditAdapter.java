...
public class AudiobookDetailsEditAdapter extends ArrayAdapter<Track>{
	...
	public AudiobookDetailsEditAdapter(Context context, int resource, List<Track> tracks) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		case TYPE_AUTHOR:
			...
			if(convertView == null){
				...
				convertView = inflater.inflate(R.layout.audiobook_item_author_edit, parent, false);
				authorHolder.author_item_et = (EditText) convertView.findViewById(R.id.author_item_edit_et);
				convertView.setTag(authorHolder);
			} else {
				authorHolder = (AuthorViewHolder) convertView.getTag();
			}
			authorHolder.author_item_et.setText(audiobook.getAuthor());
			break;
	...
	static class AuthorViewHolder {
		public EditText author_item_et;
	}
