...
import rd.dap.fragments.FolderFragment;
import rd.dap.fragments.FolderFragment.Folder_Fragment_Observer;
...
public class NewAudiobookActivity extends Activity implements Folder_Fragment_Observer {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		folderFragment = (FolderFragment) fm.findFragmentById(R.id.new_audiobook_folder_fragment);
